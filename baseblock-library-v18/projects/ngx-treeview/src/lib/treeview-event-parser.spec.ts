...
const selectionWithUndefinedCheckedItems: TreeviewSelection | any= {
    checkedItems: undefined,
    uncheckedItems: undefined
};

const selectionWithNullCheckedItems: TreeviewSelection | any= {
    checkedItems: null,
    uncheckedItems: undefined
};
...
describe('DefaultTreeviewEventParser', () => {
    ...
    let fakeComponent: TreeviewComponent | any;
