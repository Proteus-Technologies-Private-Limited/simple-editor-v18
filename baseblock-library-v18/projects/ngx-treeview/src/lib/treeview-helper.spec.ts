...
describe('findItem', () => {
    it('should not find item if root is null or undefined', () => {
        expect(TreeviewHelper.findItem(undefined as any, 1)).toBeUndefined();
        expect(TreeviewHelper.findItem(null as any, 1)).toBeUndefined();
    });
...
describe('findItemInList', () => {
    it('should not find item if list is null or undefined', () => {
        expect(TreeviewHelper.findItemInList(undefined as any, 1)).toBeUndefined();
        expect(TreeviewHelper.findItemInList(null as any, 1)).toBeUndefined();
    });
...
describe('findParent', () => {
    it('should not find parent if root is undefined or root has no children', () => {
        expect(TreeviewHelper.findParent(undefined as any, fakeItem)).toBeUndefined();
...
describe('removeParent', () => {
    it('should not remove item if root is undefined or root has no children', () => {
        expect(TreeviewHelper.removeItem(undefined as any, fakeItem)).toBeFalsy();
