...
export class TreeviewItem {
    ...
    private internalChildren: TreeviewItem[] | any;
    text: string;
    value: any;
    itemData: any;
    ...
    setCheckedRecursive(value: boolean) {
        if (!this.internalDisabled) {
            ...
            if (!_.isNil(this.internalChildren)) {
                this.internalChildren.forEach((child: any) => child.setCheckedRecursive(value));
            }
        }
    }
    ...
    set disabled(value: boolean) {
        if (this.internalDisabled !== value) {
            ...
            if (!_.isNil(this.internalChildren)) {
                this.internalChildren.forEach((child: any) => child.disabled = value);
            }
        }
    }
    ...
    setCollapsedRecursive(value: boolean) {
        this.internalCollapsed = value;
        if (!_.isNil(this.internalChildren)) {
            this.internalChildren.forEach((child: any) => child.setCollapsedRecursive(value));
        }
    }
    ...
    set children(value: TreeviewItem[]) {
        if (this.internalChildren !== value) {
            ...
            if (!_.isNil(this.internalChildren)) {
                ...
                this.internalChildren.forEach((child: any) => {
                    if (checked === null) {
