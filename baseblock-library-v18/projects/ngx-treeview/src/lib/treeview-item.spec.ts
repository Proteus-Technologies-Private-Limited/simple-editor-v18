...
describe('TreeviewItem', () => {
    it('should throw error if TreeItem param is null of undefined', () => {
        ...
        expect(() => new TreeviewItem(null as any)).toThrow(error);
        expect(() => new TreeviewItem(undefined as any)).toThrow(error);
    });
    ...
    it('should throw error if TreeItem text is not a string', () => {
        ...
        expect(() => new TreeviewItem({ text: null as any, value: 1 })).toThrow(error);
        expect(() => new TreeviewItem({ text: undefined as any, value: 1 })).toThrow(error);
    ...
    describe('children', () => {
        ...
        it('should accept undefined value', () => {
            const treeviewItem: any = new TreeviewItem({
                text: 'Parent',
                value: 1,
                children: [
                    { text: 'Child 1', value: 11 }
