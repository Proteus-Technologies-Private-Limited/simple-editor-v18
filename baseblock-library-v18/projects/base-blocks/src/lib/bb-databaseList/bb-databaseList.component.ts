...
@Component( {
    selector: 'bb-databaseList',
    templateUrl: './bb-databaseList.component.html',
    styleUrls: ['./bb-databaseList.component.css']
})
export class BBDatabaseList {
 ...
 @Output() onTabDoneData : EventEmitter<any> = new EventEmitter<any>();
    ...
    setCheckValue(  currentTab: any )
    {
        ...
        if(currentTab['name'] == 'External Data Source')
        {
            ...
            let paramMap:any = {};
            var url = this.sqlService.getHostURL() + '/ibase/rest/Databasecatlog/getExtDBConnection';
