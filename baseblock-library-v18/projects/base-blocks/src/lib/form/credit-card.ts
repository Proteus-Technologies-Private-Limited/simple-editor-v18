...
export function cards() { let cards: Array<any> = [
  {
    type: 'maestro',
...
export abstract class CreditCard {
  ...
  public static cardFromNumber(num:any) {
    let card,
        p,
        pattern,
        ref;
  ...
  public static restrictNumeric(e:any): boolean {
    let input;
  ...
  public static hasTextSelected(target:any) {
    return target.selectionStart !== null && target.selectionStart !== target.selectionEnd;
  }

  public static cardType(num:any) {
    if (!num) {
      return num;
    }
  ...
  public static safeVal(value:any, target:any) {
    let cursor: any = null,
      last   = target.value,
        result: any = null;
  ...
  public static isCardNumber(key:any, target:any) {
    let card,
        digit,
        value,
        result;
  ...
  public static restrictExpiry(key:any, target:any) {
    let digit,
        value;
    digit = String.fromCharCode(key);
  ...
  public static replaceFullWidthChars(str:any) {
    if (str === null) {
      str = '';
    }
  ...
  public static formatExpiry(expiry:any) {
  ...
  public static restrictCvc(key:any, target:any) {
  ...
  public static luhnCheck(num:any) {
    let digit,
