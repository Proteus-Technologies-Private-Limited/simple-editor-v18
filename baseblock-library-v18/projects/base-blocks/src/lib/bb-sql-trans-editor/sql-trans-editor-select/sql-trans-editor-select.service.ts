...
import { MatDialog } from '@angular/material/dialog';//added by mayuri
// Added by nikhil on 12-01-2022 for scheduler visual for user info	
const serviceUrl = '/ibase/rest/GenProcessPreviewService';

@Injectable()
export class SQLTransEditorService {
// Added by nikhil on 12-01-2022 for scheduler visual for user info		
public baseUrl: string = serviceUrl;
alertMsgList:any = []; //added by mayuri
typeofAlertList:any = [];//added by mayuri
errorColumnNameList:any = [];//added by mayuri
columnNaame:any = null;//added by mayuri
confirmBox:any = null;//added by mayuri
isForcedSave: boolean = false;//added by mayuri
...
//added by mayuri on 18/08/2023 Check for alias for columns in repsonse and add columns start
...
//added by mayuri on 18/08/2023 Check for alias for columns in repsonse and add columns end
