...
import { BBtransDatabaseListService } from '../bb-transDatabaseList/bb-transDatabaseList.service';


@Component( {
    selector: 'bb-transTabWithList',
    templateUrl: './bb-transTabWithList.component.html',
    styleUrls: ['./bb-transTabWithList.component.css']
})
export class BBtransTabWithList {
 ...
 //currentFeedArray = [];
    ...
    try 
    {
      ...
      //  paramMap["databaseName"] = this.currenSelectedTab['name'];
        ...
        var url = this.sqlService.getHostURL() + '/ibase/rest/TransDatabasecatlog/table/structure';
